...
class MovieSpecsDtoMapper : DomainMapper<MovieSpecsDto, MovieSpecs> {

    override fun mapToDomainModel(model: MovieSpecsDto): MovieSpecs {
        return MovieSpecs(
            adult = model.adult,
    ...
    override fun mapFromDomainModel(domainModel: MovieSpecs): MovieSpecsDto {
        return MovieSpecsDto(
    ...
    fun toDomainList(initial: List<MovieSpecsDto>): List<MovieSpecs>{
