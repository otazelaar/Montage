...
class GetTmdbMovieTest {
    ...
    // system in test
    private lateinit var getTmdbMovie: GetTmdbMovie
    ...
    fun getMoviesFromNetwork_getMovieById(): Unit = runBlocking {
        ...
        // run use case
        val movieAsFlow = getTmdbMovie.execute(
            tmdb_apikey = FAKE_APIKEY,
            id = MOVIE_ID,
            isNetworkAvailable = true
        ).toList()
